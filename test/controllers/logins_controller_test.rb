...
class LoginsControllerTest < ActionController::TestCase
  ...
  test "should create login" do
    assert_difference('Login.count') do
      post :create, login: { emali: @login.emali, encrypted_password: @login.encrypted_password, name: @login.name, salt: @login.salt }
    end
  ...
  test "should update login" do
    patch :update, id: @login, login: { emali: @login.emali, encrypted_password: @login.encrypted_password, name: @login.name, salt: @login.salt }
    assert_redirected_to login_path(assigns(:login))
  end
